...
& (\mathit{mot} : (i_1 : I_1) \to \ldots \to (i_m : I_m) \to \SET{}) \to \\
...
& \mathtit{mot}\ i_1\ \ldots\ i_n\ \mathit{tgt}
  \end{align*}
where $\overline{\Psi}$ represents the sequence of variables bound in the telescope $\Psi$.
