...
The first step is to quote the quoted expression argument again, yielding a quotation of a quotation.
...
The value of {\tt sampleTerm} is \texttt{lam visible (abs "n" (var 0 []))}. 
The constructor \texttt{lam} encodes the abstract representation of the identity function. The argument {\tt n} is represented as explicit and the body of the lambda function refers to {\tt n} using a de-bruijn index.   
