...
\fontsize{7.9pt}{0pt}\selectfont
\begin{align*}
&\KW{data}\ D\ (a_1 : A_1) \ldots (a_n:A_n) : (i_1 : I_1) \rightarrow\ldots\rightarrow (i_n : I_n) \rightarrow \SET{}\ \KW{where}  \\
&\hspace{0.3cm} c_1 : \Delta_1 \rightarrow D \, a_1 \ldots a_n \, j_{11} \ldots j_{1m}  \\
&\hspace{3.5cm} \vdots  \\
&\hspace{0.3cm} c_n : \Delta_n \rightarrow D \, a_1 \ldots a_n \, j_{n1} \ldots j_{nm}  \\
\end{align*}
\endgroup
\end{center}
\normalsize
where $j_{k1} \ldots j_{km}$ are bound in the telescope $\Delta_k$.
